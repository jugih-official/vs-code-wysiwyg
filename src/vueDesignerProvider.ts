...
import { getVueWebviewContent } from './vueWebviewContent';

export class VueDesignerProvider implements vscode.CustomTextEditorProvider {
    ...
    public async resolveCustomTextEditor(
        ...
        // Set initial content
        webviewPanel.webview.html = getVueWebviewContent(webviewPanel.webview, this.context);
